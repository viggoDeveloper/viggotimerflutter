...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'myrecord_Page',
          path: '/myrecordPage',
          builder: (context, params) => MyrecordPageWidget(
            idUser: params.getParam(
                'idUser', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          name: 'registerNewUser_Page',
          path: '/registerNewUserPage',
          builder: (context, params) => RegisterNewUserPageWidget(),
        ),
        FFRoute(
          name: 'viewAllrepor_Page',
          path: '/viewAllreporPage',
          builder: (context, params) => ViewAllreporPageWidget(),
        ),
        FFRoute(
          name: 'viewDataReportUser_Page',
          path: '/viewDataReportUserPage',
          builder: (context, params) => ViewDataReportUserPageWidget(
            data: params.getParam(
                'data', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => MarkAttendanceWidget(
            ...
            campus: params.getParam('campus', ParamType.String),
